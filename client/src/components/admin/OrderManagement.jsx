...
// import { useState, useEffect } from "react"
// import { getAdminOrders, updateOrderStatus, confirmOrderPayment } from "../../services/api"
...
//         }}
//       >
//         <h3 style={{ marginBottom: "1rem", color: "#333", fontSize: "1.1rem" }}>Current Page Summary</h3>
//         <div
//           style={{
//             display: "grid",
...
//             }}
//           >
//             <div style={{ fontSize: "1.5rem", fontWeight: "bold", color: "#495057" }}>{statusCounts.all}</div>
//             <div style={{ fontSize: "0.85rem", color: "#6c757d", marginTop: "0.25rem" }}>All Orders</div>
//           </div>
...
//             }}
//           >
//             <div style={{ fontSize: "1.5rem", fontWeight: "bold", color: "#ffc107" }}>{statusCounts.processing}</div>
//             <div style={{ fontSize: "0.85rem", color: "#6c757d", marginTop: "0.25rem" }}>Processing</div>
//           </div>
...
//             }}
//           >
//             <div style={{ fontSize: "1.5rem", fontWeight: "bold", color: "#28a745" }}>{statusCounts.confirmed}</div>
//             <div style={{ fontSize: "0.85rem", color: "#6c757d", marginTop: "0.25rem" }}>Confirmed</div>
//           </div>
...
//             }}
//           >
//             <div style={{ fontSize: "1.5rem", fontWeight: "bold", color: "#17a2b8" }}>{statusCounts.shipped}</div>
//             <div style={{ fontSize: "0.85rem", color: "#6c757d", marginTop: "0.25rem" }}>Shipped</div>
//           </div>
...
//             }}
//           >
//             <div style={{ fontSize: "1.5rem", fontWeight: "bold", color: "#6f42c1" }}>{statusCounts.enroute}</div>
//             <div style={{ fontSize: "0.85rem", color: "#6c757d", marginTop: "0.25rem" }}>En Route</div>
//           </div>
...
//             }}
//           >
//             <div style={{ fontSize: "1.5rem", fontWeight: "bold", color: "#20c997" }}>{statusCounts.delivered}</div>
//             <div style={{ fontSize: "0.85rem", color: "#6c757d", marginTop: "0.25rem" }}>Delivered</div>
//           </div>
...
//             }}
//           >
//             <div style={{ fontSize: "1.5rem", fontWeight: "bold", color: "#dc3545" }}>{statusCounts.cancelled}</div>
//             <div style={{ fontSize: "0.85rem", color: "#6c757d", marginTop: "0.25rem" }}>Cancelled</div>
//           </div>
//         </div>
//       </div>
...
//                     {selectedOrder.paymentDetails.adminNotes && (
//                       <p>
//                         <strong>Admin Notes:</strong> {selectedOrder.paymentDetails.adminNotes}
//                       </p>
//                     )}
//                   </div>
//                   <div>
...
//                         </p>
//                         <img
//                           src={selectedOrder.paymentDetails.receiptImage || "/placeholder.svg"}
//                           alt="Payment Receipt"
//                           style={{
//                             maxWidth: "200px",
//                             maxHeight: "200px",
...
//               </p>
//               <p>
//                 <strong>Customer:</strong> {selectedOrder.customerInfo?.firstName}{" "}
//                 {selectedOrder.customerInfo?.lastName}
//               </p>
//               <p>
//                 <strong>Amount:</strong> Rs. {selectedOrder.total}
//               </p>
//               <p>
//                 <strong>Payment Method:</strong> {selectedOrder.paymentMethod}
//               </p>
...
//             <div style={{ marginBottom: "1rem" }}>
//               <label style={{ display: "block", marginBottom: "0.5rem", fontWeight: "bold" }}>Admin Notes:</label>
//               <textarea
//                 value={paymentNotes}
//                 onChange={(e) => setPaymentNotes(e.target.value)}
//                 placeholder="Add notes about payment verification..."
