...
const CouponManagement = () => {
  ...
  const fetchCoupons = async () => {
    setLoading(true)
    try {
      const response = await fetch("http://glowingart-ruddy.vercel.app/api/admin/coupons", {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingCoupon
        ? `http://glowingart-ruddy.vercel.app/api/admin/coupons/${editingCoupon._id}`
        : "http://glowingart-ruddy.vercel.app/api/admin/coupons"
  ...
  const handleDelete = async (couponId) => {
    ...
    setLoading(true)
    try {
      const response = await fetch(`http://glowingart-ruddy.vercel.app/api/admin/coupons/${couponId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("admin_token")}`,
        },
  ...
  const toggleCouponStatus = async (couponId, currentStatus) => {
    setLoading(true)
    try {
      const response = await fetch(`http://glowingart-ruddy.vercel.app/api/admin/coupons/${couponId}/toggle`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("admin_token")}`,
